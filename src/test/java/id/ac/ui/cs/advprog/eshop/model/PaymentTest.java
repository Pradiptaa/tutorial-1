...
class PaymentTest {
    ...
    void testCreatePaymentWithNoOrder() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), null, paymentData);
        });
        paymentData.clear();
    }
    ...
    void testCreatePaymentWithEmptyPaymentData() {
        paymentData.clear();
        assertThrows(IllegalArgumentException.class, () -> {
            new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), order, paymentData);
        });
    }
    ...
    void testCreatePaymentWithDefaultStatus() {
        loadCashOnDeliveryPaymentData();
        Payment payment = new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), order, paymentData);
        assertSame(order, payment.getOrder());
        assertEquals("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", payment.getId());
        assertEquals(PaymentMethod.CASH.getValue(), payment.getPaymentMethod());
    ...
    void testCreatePaymentWithSuccessStatus() {
        loadCashOnDeliveryPaymentData();
        Payment payment = new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), order, paymentData, PaymentStatus.SUCCESS.getValue());
        assertSame(order, payment.getOrder());
        assertEquals("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", payment.getId());
        assertEquals(PaymentMethod.CASH.getValue(), payment.getPaymentMethod());
        assertEquals(paymentData, payment.getPaymentData());
    ...
    void testCreatePaymentWithInvalidStatus() {
        loadCashOnDeliveryPaymentData();
        assertThrows(IllegalArgumentException.class, () -> {
            new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), order, paymentData, "MEOW");
        });
        paymentData.clear();
    }
    ...
    void testCreatePaymentWithRejectedStatus() {
        loadCashOnDeliveryPaymentData();
        Payment payment = new Payment("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", PaymentMethod.CASH.getValue(), order, paymentData, PaymentStatus.REJECTED.getValue());
        assertSame(order, payment.getOrder());
        assertEquals("a3e3e3e3-9a7f-4603-92c2-eaf529271cc9", payment.getId());
        assertEquals(PaymentMethod.CASH.getValue(), payment.getPaymentMethod());
        assertEquals(paymentData, payment.getPaymentData());
