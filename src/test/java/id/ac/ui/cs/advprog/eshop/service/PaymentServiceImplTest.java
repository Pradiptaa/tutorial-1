...
class PaymentServiceImplTest {
    ...
    void testUpdateStatusCODPaymentInvalidStatus() {
        ...
        assertEquals(PaymentMethod.CASH.getValue(), payments.get(1).getMethod());
    ...
    @Test
    void testUpdateStatusCODPaymentUnregiesteredPayment() {
        Payment codPayment = payments.get(1);
    ...
    @Test
    void testCreateCODPaymentInvalidMethod() {
        Payment codPayment = payments.get(1);
